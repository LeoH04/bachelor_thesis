...
def build_memory_update_instruction(
    ...
    return (
        ...
        "Do not repeat facts, table rows, or bullets that already appear in "
        "the previous internal memory. If a section contains duplicate rows, "
        "rewrite that section with duplicates removed. For table sections, "
        "keep at most one row for each unique source-agent, candidate, and "
        "fact combination.\n\n"
