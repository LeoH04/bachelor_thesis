...
|---|---|---|---|---|
| Candidate A |  |  | Insufficient data | No information available |
| Candidate B | very conscientious; handles stress well | can be uncooperative; makes nasty remarks about colleagues | Mixed – strong reliability and stress handling but concerns about teamwork/crew cooperation | Potential impact on crew dynamics |
...
|---|---|---|---|---|
| agent_1 | Candidate B | Candidate B | very conscientious (though can be uncooperative) | |
| agent_2 | Candidate B | Candidate B | very conscientious (noted also negative remarks) | |
| agent_3 | Candidate B | Candidate B | very conscientious; handles stress well | |
