...
| --- | --- | --- | --- | --- |
| Candidate A |  |  |  |  |
| Candidate B | Handles stress very well (reported by agent_1, agent_2, agent_3) |  | High | Stress handling critical for long-distance |
| Candidate C |  |  |  |  |
| Candidate D |  |  |  |  |
...
Uncertainties
- Lack of detailed evidence on other criteria and other candidates.
