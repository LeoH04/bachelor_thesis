...
| --- | --- | --- | --- | --- |
| Candidate A |  |  |  |  |
| Candidate B | Handles stress very well (agents 1, 2, 3) | Makes nasty remarks about colleagues (agent 2) | Promising but concerns about teamwork/communication | Needs monitoring of interpersonal behavior |
| Candidate C |  |  |  |  |
| Candidate D |  |  |  |  |
...
Rationale
- Handles stress very well (multiple confirmations)
...
| agent_2 | Candidate B | Candidate B | Handles stress very well; noted nasty remarks about colleagues | |
...
- Important Agreements
  - Candidate B handles stress very well (reported by agents 1, 2, 3)
