...
|---|---|---|---|---|
| Candidate A |  |  | Unknown |  |
| Candidate B | Handles stress very well | Makes nasty remarks about colleagues | Strong, but concerns about crew cooperation | Stress handling good; remarks may affect teamwork |
| Candidate C |  |  | Unknown |  |
| Candidate D |  |  | Unknown |  |
...
- Important Agreements
  - Agent 1 favors Candidate B (handles stress very well)
  - Agent 2 favors Candidate B (handles stress very well; notes nasty remarks)
  - Agent 3 favors Candidate B (handles stress very well)
