...
| Candidate B | handles stress very well (reported by agent_1, agent_3, agent_2) |  | Strong stress handling; suitable for long-distance flights | Supported by multiple agents |
| Candidate C | keeps calm in a crisis (reported by agent_2) |  | Good crisis management; suitable for long-distance flights | Supported by agent_2 |
...
- Uncertainties
  - Little information on Candidates A and D.
