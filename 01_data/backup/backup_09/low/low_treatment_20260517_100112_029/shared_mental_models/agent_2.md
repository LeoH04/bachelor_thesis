...
| --- | --- | --- | --- | --- |
| agent_1 | Candidate B | handles stress very well | Supports | reported by agent_1 |
...
| --- | --- | --- | --- | --- |
| agent_3 | Candidate B |  | handles stress very well |  |
| agent_1 | Candidate B |  | handles stress very well |  |
