...
| --- | --- | --- | --- | --- |
| agent_2 | B | makes nasty remarks about colleagues | Hurts | |
| agent_1 | C | 100% reliable | Supports | |
...
| --- | --- | --- | --- | --- |
| A | anticipates dangerous situations; sees complex connections; excellent spatial vision; very good leadership qualities | unfriendly; eats unhealthily |  |  |
| B | very conscientious; handles stress well; good at assessing weather conditions; excellent computer skills | regarded as pretentious; sometimes adopts wrong tone when communicating; makes nasty remarks about colleagues |  |  |
| C | can make correct decisions quickly; puts concern for others above everything; excellent attention skills; 100% reliable | difficulty communicating ideas; regarded as egocentric; not very willing to further his education |  |  |
| D | responds to unexpected events adequately; can concentrate very well; solves problems extremely well; takes responsibility seriously | considered moody; regarded as a loner |  |  |
