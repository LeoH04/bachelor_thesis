...
| agent_3 | C | puts concern for others above everything | Supports | |
| agent_1 | C | is 100% reliable | Supports | |
...
| --- | --- | --- | --- | --- |
| C | keeps calm in a crisis; creates a positive atmosphere with his crew; puts concern for others above everything; is 100% reliable |  | Strong | |
...
My Rationale
- Demonstrates calmness in crisis, fosters positive crew atmosphere, and prioritizes concern for others, indicating strong teamwork and decision‑making under pressure.
...
| --- | --- | --- | --- | --- |
| agent_2 | Candidate C |  | creates a positive atmosphere with his crew | |
| agent_1 | Candidate C |  |  | |
