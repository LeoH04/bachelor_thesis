...
| --- | --- | --- | --- | --- |
| Candidate A | can anticipate dangerous situations; sees complex connections; excellent spatial vision; very good leadership qualities | regarded as a show‑off; not open to new ideas |  |  |
| Candidate B | very conscientious; handles stress well; good at assessing weather; excellent computer skills | weak memory for numbers; makes nasty remarks about colleagues |  |  |
| Candidate C | can make correct decisions quickly; keeps calm in a crisis; understands complicated technology | difficulty communicating ideas; egocentric; not willing to further education |  |  |
| Candidate D | responds to unexpected events adequately; can concentrate very well; solves problems extremely well; takes responsibility seriously | regarded as a know‑it‑all; hot temper |  |  |
...
| agent_1 | Candidate A | Candidate A | excellent spatial vision and strong leadership | |
