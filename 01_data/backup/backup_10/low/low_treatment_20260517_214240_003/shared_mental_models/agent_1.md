...
|---|---|---|---|---|
| Candidate A | can anticipate dangerous situations; able to see complex connections; excellent spatial vision; very good leadership qualities | sometimes not good at taking criticism; can be unorganized; unfriendly (reported by agent_3) |  |  |
...
| Candidate C | known to be 100% reliable; creates a positive atmosphere with his crew; can make correct decisions quickly; keeps calm in a crisis (reported by agent_2) | difficulty communicating ideas; regarded as egocentric; not very willing to further his education |  |  |
