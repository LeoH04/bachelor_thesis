...
| --- | --- | --- | --- | --- |
| Candidate B | handles stress very well; very conscientious | sometimes adopts the wrong tone when communicating |  |  |
| Candidate C | known to be 100% reliable; creates a positive atmosphere with crew; can make correct decisions quickly |  |  |  |
...
- Agent 3 favors Candidate B (handles stress well) versus Candidate C.
