...
| agent_1 | Candidate A | is able to see complex connections | Supports | |
| agent_1 | Candidate A | has excellent spatial vision | Supports | |
| agent_1 | Candidate A | has very good leadership qualities | Supports | |
| agent_1 | Candidate A | is sometimes not good at taking criticism | Hurts | |
| agent_1 | Candidate A | can be unorganized | Hurts | |
| agent_1 | Candidate B | is very conscientious | Supports | |
| agent_1 | Candidate B | handles stress very well | Supports | |
| agent_1 | Candidate B | is good at assessing weather conditions | Supports | |
| agent_1 | Candidate B | has excellent computer skills | Supports | |
...
| agent_1 | Candidate C | is not very willing to further his education | Hurts | |
...
| agent_1 | Candidate D | has relatively weak leadership skills | Hurts | |
| agent_3 | Candidate B | handles stress very well | Supports | |
| agent_3 | Candidate B | is very conscientious | Supports | |
...
| agent_3 | Candidate B | Candidate B | very conscientious | |
