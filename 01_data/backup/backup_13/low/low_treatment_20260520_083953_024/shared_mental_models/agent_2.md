...
|---|---|---|---|---|
| agent_1 | Candidate C | Known to be 100% reliable | Supports | Reliability |
| agent_1 | Candidate C | Has difficulty communicating ideas | Hurts | Communication |
| agent_2 | Candidate C | Difficulty communicating ideas | Hurts | Communication |
| agent_2 | Candidate C | 100% reliable | Supports | Reliability |
...
| Candidate A |  |  |  |  |
| Candidate B |  |  |  |  |
| Candidate C | 100% reliable (reliability) | Difficulty communicating ideas (communication) | Potentially suitable but communication weakness may affect crew coordination | Strong reliability; needs communication improvement |
| Candidate D |  |  |  |  |
...
|---|---|---|---|---|
| agent_1 | Candidate C | Candidate C | Known to be 100% reliable; difficulty communicating ideas | |
| agent_2 | Candidate C | Candidate C | Difficulty communicating ideas; 100% reliable | |
...
- Uncertainties
  - Lack of information on Candidates A, B, D
