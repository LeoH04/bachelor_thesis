...
|---|---|---|---|---|
| Candidate A |  |  |  |  |
| Candidate B | Handles stress very well (demonstrated ability to stay calm under pressure) |  | Strong | Positive indicator for long-distance flights |
| Candidate C |  |  |  |  |
| Candidate D |  |  |  |  |
...
- Agent 1 supports Candidate B.
- Agent 2 supports Candidate B.
